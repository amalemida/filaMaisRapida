...
public class FilaMaisRapida<X> implements Cloneable {
	...
	public FilaMaisRapida(int tamanho) throws Exception {
		if (tamanho <= 0)
	...
	public String toString() {
		...
		if (this.ultimo != -1)
			ret += ", sendo o ultimo " + this.elemento[this.ultimo] + ", sendo o primeiro "
	...
	public boolean equals(Object obj) {
		...
		FilaMaisRapida<X> pil = (FilaMaisRapida<X>) obj;
	...
	// construtor de copia
	public FilaMaisRapida(FilaMaisRapida<X> modelo) throws Exception {
		if (modelo == null)
	...
	public Object clone() {
		FilaMaisRapida<X> ret = null;

		try {
			ret = new FilaMaisRapida<X>(this);
